...
(function () {
  ...
  function checkboxChanged(todo, event) {
    var index = currentNotes.findIndex(function (x) {
      return x._id === todo._id;
    });
  ...
  var notes = {
    rows: [{ title: 'Going to shopping', _id: '123154', selected: false }, { title: 'Cinema this week-end', _id: '123155', selected: false }]
  };
